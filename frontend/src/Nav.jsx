...
export default function Nav() {
  ...
  return (
    <>
      <nav className='position-sticky top-0 align-self-start d-flex flex-column justify-content-start gap-5 align-items-center w-auto px-3'>
        <Link to='/' className='nav-element mt-4'>
          <img style={{ filter: 'contrast(300%)' }} src='/membermaster-gray.svg' alt='MemberMaster logo' width='auto' />
        </Link>
